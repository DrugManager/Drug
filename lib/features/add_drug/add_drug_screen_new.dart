...
class _AddDrugScreenState extends State<AddDrugScreen> {
  ...
  Future<void> _saveDrug() async {
    ...
    final drug = Drug(
      ...
      time: _timeController.text.isEmpty ? '08:00' : _timeController.text,
      day: _dayController.text.isEmpty ? '월' : _dayController.text,
      totalDoseCount: int.tryParse(_totalDoseController.text) ?? 1,
      takenDoseCount: 0,
    );
